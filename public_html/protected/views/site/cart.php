							...
							<div class="cart-item-wrapper">
								...
								<div class="cart-item-count">
									<div class="count-minus-wrap">
										<a class="count-minus basket_item_del" href="/catalog/delete/<?php echo $product['fid']!=0 ? $product['fid'] : $product['id']?>">
								...
								<a href="/catalog/delete/<?php echo $product['fid']!=0 ? $product['fid'] : $product['id']?>?all=true"  alt="удалить из корзины" class="non basket_item_del">
								<span>Удалить</span>
									<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
