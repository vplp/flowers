...
<div class="wrap_sizes wrap_item" style="position:relative;overflow: hidden;">
	...
	<div id ="nav_prev_<?php echo $product['id']?>" class="prev_item nav_item">
		<!--<a class="preview_item prev non" href="/catalog/<?php //echo $prev['cat_uri']?>/<?php //echo
        //$prev['id']?>">-->
	...
	<div id ="nav_next_<?php echo $product['id']?>" class="next_item nav_item">
		<!--<a class="preview_item next non" href="/catalog/<?php //echo $next['cat_uri']?>/<?php //echo
          // $next['id']?>">-->
	...
	<div  id ="content_item_<?php echo $product['id']?>"  class="content_item <?php if(!Yii::app()->request->isPostRequest) echo 'item_def'?> 	" data-href="/catalog/<?php echo $product['id']?>" data-title="<?php if (isset($product['meta_title']) 	&&  $product['meta_title'] != '') echo $product['meta_title']; else echo $product['name'];?>">
		<?php 
